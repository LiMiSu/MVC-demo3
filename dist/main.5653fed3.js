...
var eventBus = (0, _jquery.default)({}); //数据相关放到M
...
var v = {
  ...
  render: function render(container, n) {
    (0, _jquery.default)(container).empty();
    (0, _jquery.default)(v.html.replace('{{n}}', m.data.n)).appendTo((0, _jquery.default)(container));
  }
}; // 其他放到C
...
var c = {
  init: function init(container) {
    ...
    c.autoBindEvents(container); //监听m
...
var v = {
  html: function html(index) {
    //可以把html变成函数，就可以传参，可以用data-index做标记
  ...
  render: function render(container, index) {
    (0, _jquery.default)(container).empty();
    (0, _jquery.default)(v.html(index)).appendTo((0, _jquery.default)(container));
  }
}; // 其他放到C
...
var v = {
  html: function html(active) {
    return "\n       <div>\n        <div class=\"".concat(active === 'yes' ? 'square active' : 'square', "\" ></div>\n       </div>\n        ");
  },
  render: function render(container, active) {
    (0, _jquery.default)(container).empty();
    (0, _jquery.default)(v.html(active)).appendTo((0, _jquery.default)(container));
  }
}; // 其他放到C
...
var c = {
  ...
  move: function move() {
    ...
    var active = localStorage.getItem(localKey);
    var newD = {
      active: active
    };
    m.update(newD);
...
//# sourceMappingURL=main.5653fed3.js.map